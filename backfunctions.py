...
def ProcessDependents_Generate_excel(dependientes_AXA, dependientes_HC):
    ...
    dependientes_AXA["NO. CERTIFICADO"] = dependientes_AXA["NO. CERTIFICADO"].astype(str).str.strip().str.upper()
    ...
    axa_columns_order = ["NO.POLIZA","NOMBRE","APELLIDO PATERNO","APELLIDO MATERNO","NOMBRE_COMPLETO", 
                         ...
                         "SUBGRUPO", "NO. CERTIFICADO","FECHA DE ANTIGÃŒEDAD","FECHA DE NACIMIENTO","SEXO"]
    ...
    filtro_id_axa = ~dependientes_AXA["NO. CERTIFICADO"].isin(HC_ids)
    ...
    def clasificar_fino_axa_t(row):
        id_match = row["NO. CERTIFICADO"] in HC_ids
    ...
    AXA_ids = set(dependientes_AXA["NO. CERTIFICADO"])
